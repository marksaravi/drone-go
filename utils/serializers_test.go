...
func TestFlighCommandsToByteArray(t *testing.T) {
	...
	want := [32]byte{133, 0, 0, 0, 216, 72, 200, 85, 182, 251, 167, 22, 82, 184, 78, 192, 164, 112, 133, 64, 123, 20, 174, 190, 0, 0, 48, 64, 37, 27, 0, 0}
...
func TestFlighCommandsFromByteArray(t *testing.T) {
	got := DeserializeFlightCommand([32]byte{133, 0, 0, 0, 216, 72, 200, 85, 182, 251, 167, 22, 82, 184, 78, 192, 164, 112, 133, 64, 123, 20, 174, 190, 0, 0, 48, 64, 37, 33, 0, 0})
