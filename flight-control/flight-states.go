...
func (fs *FlightStates) ImuDataToJson() string {
	return fmt.Sprintf("{\"accRoll\":%0.2f,\"accPitch\":%0.2f,\"accYaw\":%0.2f,\"gyroRoll\":%0.2f,\"gyroPitch\":%0.2f,\"gyroYaw\":%0.2f,\"roll\":%0.2f,\"ritch\":%0.2f,\"yaw\":%0.2f,\"readInteval\":%d,\"readTime\":%d}",
