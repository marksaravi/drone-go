...
const (
	...
	XG_OFFS_USRH uint16 = BANK2 | 0x3
	XG_OFFS_USRL uint16 = BANK2 | 0x4
	YG_OFFS_USRH uint16 = BANK2 | 0x5
	YG_OFFS_USRL uint16 = BANK2 | 0x6
...
const (
	...
	GYRO_SCALE_250DPS  float64 = 131
	GYRO_SCALE_500DPS  float64 = 65.5
	GYRO_SCALE_1000DPS float64 = 32.8
	GYRO_SCALE_2000DPS float64 = 16.4
)
